		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="btn-group">
					...
					<div class="dropdown">
						<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">loại sản
							phẩm
					...
					<ul class="nav navbar-nav">
						<li>
							<div class="dropdown">
								...
								<div class="dropdown-menu"  style="min-width:350px; height: 400px; z-index: 10000">
									<div class="row ">
										<div class="col-lg-4">
